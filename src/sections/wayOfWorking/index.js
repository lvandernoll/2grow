...
const WayOfWorkingSection = () =>
  <Section name='onze-werkwijze' className={styles.wayOfWorking}>
    ...
    <div className={styles.wayOfWorkingRow}>
      <img src={arrow1} className={styles.wayOfWorkingRowArrow} />
    ...
    <div className={styles.wayOfWorkingRow}>
      ...
      <img src={arrow2} className={styles.wayOfWorkingRowArrow} />
    </div>
    <div className={styles.wayOfWorkingRow}>
      <img src={arrow3} className={styles.wayOfWorkingRowArrow} />
